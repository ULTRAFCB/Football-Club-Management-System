...
<hr align="center" width="87%" class="hr1">		 
		  ...
		  <form name="form1"  action="<%=path%>/tuserCtrl/edtSingle"  onsubmit="return check(this)">
		  <c:forEach items="${singleList}" var="a">
              <table width="404" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <select name="trightID" >
                  	<option  value="${a.trightid}" selected="selected">${a.description}</option>
		    		<c:forEach items="${rnameList}" var="b">
		    		<c:if test="${b.trightid ne a.trightid}">
		    			<option  value="${b.trightid}">${b.description}</option>
		    			</c:if>
		   			</c:forEach>
		   		  </select>
                    * </td>
                ...
                <tr>
                  ...
                  <td width="338"><input id="username" readonly="readonly" name="username" type="text" size="30" value="${a.username}"> 
                   <input  name="tuserID" type="hidden" size="30" value="${a.tuserid}">
                    <input  name="tuserrightrelationID" type="hidden" size="30" value="${a.tuserrightrelationid}"> 
                   </td>
                </tr>
                  <tr>
