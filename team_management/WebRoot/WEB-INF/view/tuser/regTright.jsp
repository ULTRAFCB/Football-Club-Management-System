  ...
  <tr>
    ...
    <td width="822" height="352" valign="top" class="wordOrange"><table width="100%" height="153" border="0" cellpadding="0" cellspacing="0">
         <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">您当前的位置</span>：[权限信息管理]-[新增权限]</td>
        </tr>
        <tr>
          <td height="290" colspan="2" valign="top" bgcolor="#FBFBFB">
<hr align="center" width="87%" class="hr1">		 
		  <form name="form1" method="get" action="tuserCtrl/regTright"  onsubmit="return check(this)">
              <table width="404" border="0" align="center" cellpadding="0" cellspacing="0">
               ...
               <tr>
                  ...
                  <td width="338"><input name="rname" type="text" size="30" readonly="readonly" value="${param.action}">
                  ...
                  <td width="338"><input name="description" type="text" size="30"  >
                 ...
                 <tr>
                  <td width="66" height="30" align="center">是否继续添加：</td>
                  <td width="338"><input name="sign" type="radio"  size="50" value="continue" >继续
                  					<input name="sign" type="radio"  size="50" value="no" checked="checked" >不继续
