  ...
  <tr>
    ...
    <td width="822" height="352" valign="top" class="wordOrange" background="images/tab_05.gif"><table width="100%" height="153" border="0" cellpadding="0" cellspacing="0">
         <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">您当前的位置</span>：[球队信息管理]-[球队简介管理]-[修改球队简介]</td>
        </tr>
        <tr>
          <td height="290" colspan="2" valign="top" bgcolor="#FBFBFB">
<hr align="center" width="87%" class="hr1">		 
		  <form name="form1" method="get" action="summaryCtrl/edtSummary"  onsubmit="return check(this)">
              <table width="404" border="0" align="center" cellpadding="0" cellspacing="0">
                 ...
                 <tr>
                  ...
                  <td width="338"><input name="years" type="text"  size="30" value="<%=request.getParameter("years")%>">
                  <input  name="summaryID" type="hidden" size="30" value="<%=request.getParameter("summaryID")%>"> 
                    * </td>
                </tr>
                <tr>
                  <td width="66" height="30" align="center">日&nbsp;&nbsp;期：</td>
                  <td width="338"><input name="days"    type="text" size="30"  value="<%=request.getParameter("days")%>">
                    * </td>
                </tr>
                      <tr>
                  <td width="66" height="30" align="center">标&nbsp;&nbsp;题：</td>
                  <td width="338"><input name="title" type="text" size="30" value="<%=request.getParameter("title")%>" >
                    * </td>
                </tr>
                    <tr>
                  <td width="66" height="30" align="center">内&nbsp;&nbsp;容：</td>
                  <td width="338"><input name="content" type="text" size="30" value="${param.content}" >
                    * </td>
                </tr>
               <tr>
