  ...
  <tr>
    ...
    <td width="822" height="352" valign="top" class="wordOrange" background="images/tab_05.gif"><table width="100%" height="153" border="0" cellpadding="0" cellspacing="0">
         <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">您当前的位置</span>：[备忘录管理]-[新增备忘录]</td>
        </tr>
        <tr>
          <td height="290" colspan="2" valign="top" bgcolor="#FBFBFB">
<hr align="center" width="87%" class="hr1">		 
		  <form name="form1" method="get" action="memoCtrl/regMemo"  onsubmit="return check(this)">
              <table width="404" border="0" align="center" cellpadding="0" cellspacing="0">
               ...
               <tr>
                  ...
                  <td width="338"><input name=time type="text" size="30"  >
                    <input type="hidden" name="tuserID" value="${sessionScope.tuserid}"/> 
                    <input type="hidden" name="mark" value="0"/> </td>
                </tr>
