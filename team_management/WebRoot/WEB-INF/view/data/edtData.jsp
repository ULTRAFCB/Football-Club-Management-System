  ...
  <tr>
    ...
    <td width="822" height="352" valign="top" class="wordOrange"><table width="100%" height="153" border="0" cellpadding="0" cellspacing="0">
         <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">您当前的位置</span>：[球队日常管理]-[数据统计管理]-[修改数据]</td>
        </tr>
        <tr>
          <td height="290" colspan="2" valign="top" bgcolor="#FBFBFB">
<hr align="center" width="87%" class="hr1">		 
		  <form name="form1" method="get" action="dataCtrl/edtData"  onsubmit="return check(this)">
              <table width="404" border="0" align="center" cellpadding="0" cellspacing="0">
                 ...
                 <tr>
                  ...
                  <td width="338"><input  type="text" readonly="readonly" size="30" value="<%=request.getParameter("realname")%>">
                  <input  name="tuserID" type="hidden" size="30" value="<%=request.getParameter("tuserid")%>"> 
                   <input   name="dataID" type="hidden" size="30" value="<%=request.getParameter("dataid")%>">
                    * </td>
                </tr>
                <tr>
              ...
              <tr>
                  ...
                  <td width="338"><input name="minutes" type="text" size="30" value="${param.minutes}" >
                     </td>
                </tr>
           
                   <tr>
                  <td width="120" height="30" align="center">进球数：</td>
                  <td width="338"><input name="goals" type="text"  size="50"  value="${param.goals}">
                  					
                     </td>
                </tr>
                    <tr>
                  <td width="120" height="30" align="center">助攻数：</td>
                  <td width="338"><input name="assists" type="text"  size="50" value="${param.assists}">
                  					
                     </td>
                </tr>
                    <tr>
                  <td width="120" height="30" align="center">传球数：</td>
                  <td width="338"><input name="pass" type="text"  size="50" value="${param.pass}">
                  					
                     </td>
                </tr>
                    <tr>
                  <td width="120" height="30" align="center">抢断数：</td>
                  <td width="338"><input name="tackles" type="text"  size="50" value="${param.tackles}">
                  					
                     </td>
                </tr>
                    <tr>
                  <td width="120" height="30" align="center">解围数：</td>
                  <td width="338"><input name="clear" type="text"  size="50" value="${param.clear}" >
                  					
                     </td>
                </tr>
                    <tr>
                  <td width="120" height="30" align="center">犯规数：</td>
                  <td width="338"><input name="fouls" type="text"  size="50" value="${param.fouls}">
