  ...
  <tr>
    ...
    <td width="822" height="352" valign="top" class="wordOrange"><table width="100%" height="153" border="0" cellpadding="0" cellspacing="0">
         <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">您当前的位置</span>：[球队日常管理]-[训练计划管理]-[增加训练计划]</td>
        </tr>
        <tr>
          <td height="290" colspan="2" valign="top" bgcolor="#FBFBFB">
<hr align="center" width="87%" class="hr1">		 
		   <form name="form1" method="get" action="trainCtrl/regTrain"  onsubmit="return check(this)">
              <table width="404" border="0" align="center" cellpadding="0" cellspacing="0">
               ...
               <tr>
                  <td width="120" height="30" align="center">时间：</td>
                  <td width="338"><input name="time" type="text" size="30"  >
                  <input name="coachname" type="hidden" size="30" value="${realname}" >
                  <input name="coachdp" type="hidden" size="30" value="${description}" >
                     
                     </td>
                </tr>
           
                   <tr>
                  <td width="120" height="30" align="center">训练内容：</td>
